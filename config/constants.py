...
# Very wide range to capture all available liquid options
MIN_STRIKE_PCT = 0.50  # 50% of spot price (very deep OTM puts)
MAX_STRIKE_PCT = 1.50  # 150% of spot price (very deep OTM calls)
